...
<header class="dashboard-header">
  <div class="left-section">
    <img src="${pageContext.request.contextPath}/assets/ftlogowhite.png" alt="FinTrust Logo" class="logo">
    <button id="menu-toggle" class="menu-btn" title="Menu">&#9776;</button>
    <h4>DASHBOARD</h4>
  </div>

  <div class="right-section">
    <img src="${pageContext.request.contextPath}/assets/email.webp" alt="Email" class="icon">
    <div class="profile">
  ...
  <%--     <div class="user-info">
        ...
        <p class="user-id">${sessionScope.personId}</p>
      </div> --%>
    </div>
